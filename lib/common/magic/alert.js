...
exports.AlertMagicHandlerCompact = exports.AlertMagicHandler = exports.SetAlertHandler = exports.SetAlertConceptName = void 0;
const inlinejs_1 = require("@benbraide/inlinejs");
const names_1 = require("../names");
let AlertConceptName = '';
let AlertHandler = null;
function SetAlertConceptName(name) {
    AlertConceptName = name;
}
exports.SetAlertConceptName = SetAlertConceptName;
